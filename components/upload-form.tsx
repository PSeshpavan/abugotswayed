  ...
  return (
    <Card className="w-full max-w-2xl mx-auto shadow-lg border-2 border-primary/20">
      ...
      <CardContent className="space-y-6">
        <div
          className="border-2 border-dashed border-primary/30 rounded-lg p-8 text-center hover:border-primary/50 transition-colors cursor-pointer bg-gradient-to-br from-primary/5 to-secondary/5"
